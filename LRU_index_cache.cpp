/*
  ...
  Description: A slightly modified version of the LRU cache concept, in which instead of being able to insert a key and value pair, 
               ...
               them to indices in the array of textures, so that a texture could be easily corresponded to a chunk based on its position. Given a list of chunks that need to be rendered, for each chunk, I would check if
